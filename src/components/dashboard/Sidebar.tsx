...
export default function Sidebar() {
    ...
    return (
        <aside className="fixed top-0 left-0 bottom-0 w-60 bg-surface border-r border-border-main flex flex-col z-[100]">
            <div className="sb-logo font-display text-2xl text-apex-accent tracking-[3px] p-6 border-b border-border-main">
                APEX
            </div>
            ...
            <div className="p-4 border-t border-border-main">
                <button
                    ...
                    className="flex items-center gap-2 text-apex-dim text-[0.82rem] transition-colors hover:text-apex-danger"
                >
